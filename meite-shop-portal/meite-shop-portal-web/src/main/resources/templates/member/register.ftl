		...
		<div class="layui-container">
			<div class="house-nav">
				<span class="layui-breadcrumb" lay-separator="|"> <a
					href="/login.html" style="color: #f10a0a !important;">登录</a> <a
					href="">我的订单</a> <a
		...
		<div class="layui-fulid" id="house-login">
			<div class="layui-form">
				...
				<div class="layui-input-block-weixinQRcode"
					...
					<img alt="" src="https://jdbc.oss-cn-beijing.aliyuncs.com/wx_test.png">
				...
				<div class="layui-input-block login" style="margin-top: 12px;">
					<i class="layui-icon layui-icon-vercode"></i> <input
						value="${(registerVo.registCode)!''}" name="registerCode"
