	...
	<div class="head">
		<div class="head-center">
			<img class="head-center-logo"
				src="https://jdbc.oss-cn-beijing.aliyuncs.com/qq.png" />
			<div class="head-center-font">充值中心</div>
			<div class="head-center-user">用户名：admin</div>
		</div>
