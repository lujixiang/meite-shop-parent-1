package com.java.pay.callback.template.unionpay;
...
public class UnionPayCallbackTemplate extends AbstractPayCallbackTemplate {
	...
	public String asyncService(Map<String, String> verifySignature) {
		...
		PaymentTransactionEntity paymentTransaction = paymentTransactionDao.selectOne(new LambdaQueryWrapper<PaymentTransactionEntity>().eq(PaymentTransactionEntity::getPaymentId,orderId));
