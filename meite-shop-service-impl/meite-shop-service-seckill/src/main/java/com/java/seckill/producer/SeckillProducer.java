package com.java.seckill.producer;
...
public class SeckillProducer implements RabbitTemplate.ConfirmCallback {
	...
	public void send(JSONObject jsonObject) {
		...
		rabbitTemplate.convertAndSend(MQConstants.SECKILL_EXCHANGE, MQConstants.UPDATE_STOCK_ROUTING_KEY, message, correlationData);
